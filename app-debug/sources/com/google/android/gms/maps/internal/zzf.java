...
public final class zzf extends zza implements zze {
    ...
    public final IMapViewDelegate zza(IObjectWrapper iObjectWrapper, GoogleMapOptions googleMapOptions) throws RemoteException {
        ...
        googleMapOptions = iObjectWrapper.readStrongBinder();
        if (googleMapOptions == null) {
            googleMapOptions = null;
        } else {
            IInterface queryLocalInterface = googleMapOptions.queryLocalInterface("com.google.android.gms.maps.internal.IMapViewDelegate");
            if (queryLocalInterface instanceof IMapViewDelegate) {
                googleMapOptions = (IMapViewDelegate) queryLocalInterface;
            } else {
                googleMapOptions = new zzk(googleMapOptions);
            }
        }
        iObjectWrapper.recycle();
    ...
    public final IStreetViewPanoramaViewDelegate zza(IObjectWrapper iObjectWrapper, StreetViewPanoramaOptions streetViewPanoramaOptions) throws RemoteException {
        ...
        iObjectWrapper = zza(7, zza);
        streetViewPanoramaOptions = iObjectWrapper.readStrongBinder();
        if (streetViewPanoramaOptions == null) {
            streetViewPanoramaOptions = null;
        } else {
            IInterface queryLocalInterface = streetViewPanoramaOptions.queryLocalInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaViewDelegate");
            if (queryLocalInterface instanceof IStreetViewPanoramaViewDelegate) {
                streetViewPanoramaOptions = (IStreetViewPanoramaViewDelegate) queryLocalInterface;
            } else {
                streetViewPanoramaOptions = new zzbw(streetViewPanoramaOptions);
            }
        }
        iObjectWrapper.recycle();
