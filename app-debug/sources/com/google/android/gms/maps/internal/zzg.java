...
public final class zzg extends zza implements IGoogleMapDelegate {
    ...
    public final zzz addPolyline(PolylineOptions polylineOptions) throws RemoteException {
        ...
        polylineOptions = zza(9, zza);
        zzz zzi = zzaa.zzi(polylineOptions.readStrongBinder());
        polylineOptions.recycle();
        return zzi;
    }
    ...
    public final zzw addPolygon(PolygonOptions polygonOptions) throws RemoteException {
        ...
        polygonOptions = zza(10, zza);
        zzw zzh = zzx.zzh(polygonOptions.readStrongBinder());
        polygonOptions.recycle();
        return zzh;
    }
    ...
    public final zzt addMarker(MarkerOptions markerOptions) throws RemoteException {
        ...
        markerOptions = zza(11, zza);
        zzt zzg = zzu.zzg(markerOptions.readStrongBinder());
    ...
    public final zzk addGroundOverlay(GroundOverlayOptions groundOverlayOptions) throws RemoteException {
        ...
        groundOverlayOptions = zza(12, zza);
        zzk zzd = zzl.zzd(groundOverlayOptions.readStrongBinder());
        groundOverlayOptions.recycle();
        return zzd;
    }
    ...
    public final zzac addTileOverlay(TileOverlayOptions tileOverlayOptions) throws RemoteException {
        ...
        tileOverlayOptions = zza(13, zza);
        zzac zzj = zzad.zzj(tileOverlayOptions.readStrongBinder());
        tileOverlayOptions.recycle();
        return zzj;
    }
    ...
    public final zzh addCircle(CircleOptions circleOptions) throws RemoteException {
        ...
        circleOptions = zza(35, zza);
        zzh zzc = zzi.zzc(circleOptions.readStrongBinder());
        circleOptions.recycle();
        return zzc;
    }
    ...
    public final boolean setMapStyle(MapStyleOptions mapStyleOptions) throws RemoteException {
        ...
        mapStyleOptions = zza(91, zza);
        boolean zza2 = zzc.zza(mapStyleOptions);
        mapStyleOptions.recycle();
        return zza2;
    }
