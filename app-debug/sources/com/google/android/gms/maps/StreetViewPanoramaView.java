...
public class StreetViewPanoramaView extends FrameLayout {
        ...
        protected final void createDelegate(OnDelegateCreatedListener<zza> onDelegateCreatedListener) {
            ...
            if (this.zzbd != null && getDelegate() == null) {
                try {
                    ...
                    onDelegateCreatedListener = this.zzbw.iterator();
                    while (onDelegateCreatedListener.hasNext()) {
                        ((zza) getDelegate()).getStreetViewPanoramaAsync((OnStreetViewPanoramaReadyCallback) onDelegateCreatedListener.next());
                    }
                    this.zzbw.clear();
    ...
    public StreetViewPanoramaView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.zzcd = new zzb(this, context, 0);
    }
