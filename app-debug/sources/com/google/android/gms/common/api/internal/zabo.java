    ...
    public final void run() {
        if (this.zaiy.isSuccess()) {
            ...
            try {
                ...
                ((zaa) this.zajf.zail.zaih.get(this.zajf.zafp)).onConnectionFailed(new ConnectionResult(10));
                return;
            }
        }
        ((zaa) this.zajf.zail.zaih.get(this.zajf.zafp)).onConnectionFailed(this.zaiy);
    }
}
