...
public abstract class VolumeProviderCompat {
    ...
    class C02591 implements Delegate {
        C02591() {
        }
    ...
    public Object getVolumeProvider() {
        if (this.mVolumeProviderObj == null && VERSION.SDK_INT >= 21) {
            this.mVolumeProviderObj = VolumeProviderCompatApi21.createVolumeProvider(this.mControlType, this.mMaxVolume, this.mCurrentVolume, new C02591());
        }
