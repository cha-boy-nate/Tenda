...
public final class MediaBrowserCompat {
    ...
    public static class MediaItem implements Parcelable {
        public static final Creator<MediaItem> CREATOR = new C00921();
        ...
        static class C00921 implements Creator<MediaItem> {
            C00921() {
            }
    ...
    static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public void connect() {
            ...
            this.mState = 2;
            this.mHandler.post(new C00841());
        }

        public void disconnect() {
            this.mState = 0;
            this.mHandler.post(new C00852());
        }
