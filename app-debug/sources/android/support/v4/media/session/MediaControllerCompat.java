...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:22:0x0040 in {2, 12, 15, 18, 21} preds:[]
...
*/
        ...
        L_0x0005:
            ...
            monitor-enter(r0);
            r1 = r6.mPendingCallbacks;	 Catch:{ all -> 0x003d }
            r1 = r1.iterator();	 Catch:{ all -> 0x003d }
        L_0x000e:
            r2 = r1.hasNext();	 Catch:{ all -> 0x003d }
            if (r2 == 0) goto L_0x0036;	 Catch:{ all -> 0x003d }
        L_0x0014:
            r2 = r1.next();	 Catch:{ all -> 0x003d }
            r2 = (android.support.v4.media.session.MediaControllerCompat.Callback) r2;	 Catch:{ all -> 0x003d }
            r3 = new android.support.v4.media.session.MediaControllerCompat$MediaControllerImplApi21$ExtraCallback;	 Catch:{ all -> 0x003d }
            r3.<init>(r2);	 Catch:{ all -> 0x003d }
            r4 = r6.mCallbackMap;	 Catch:{ all -> 0x003d }
            r4.put(r2, r3);	 Catch:{ all -> 0x003d }
            r4 = 1;	 Catch:{ all -> 0x003d }
            r2.mHasExtraCallback = r4;	 Catch:{ all -> 0x003d }
            r4 = r6.mExtraBinder;	 Catch:{ RemoteException -> 0x002e }
            r4.registerCallbackListener(r3);	 Catch:{ RemoteException -> 0x002e }
            goto L_0x000e;
        L_0x002e:
            r1 = move-exception;
            r4 = "MediaControllerCompat";	 Catch:{ all -> 0x003d }
            r5 = "Dead object in registerCallback.";	 Catch:{ all -> 0x003d }
            android.util.Log.e(r4, r5, r1);	 Catch:{ all -> 0x003d }
        L_0x0036:
            r1 = r6.mPendingCallbacks;	 Catch:{ all -> 0x003d }
