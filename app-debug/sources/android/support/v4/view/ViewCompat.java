...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:27:0x0065 in {2, 5, 11, 16, 20, 21, 23, 26} preds:[]
...
*/
            /*
            r8 = this;
            r0 = r8.mViewsContainingListeners;
        ...
        L_0x0010:
            r0 = sViewsWithListeners;
            monitor-enter(r0);
            r1 = r8.mViewsContainingListeners;	 Catch:{ all -> 0x0062 }
            if (r1 != 0) goto L_0x001e;	 Catch:{ all -> 0x0062 }
        L_0x0017:
            r1 = new java.util.WeakHashMap;	 Catch:{ all -> 0x0062 }
            r1.<init>();	 Catch:{ all -> 0x0062 }
            r8.mViewsContainingListeners = r1;	 Catch:{ all -> 0x0062 }
        L_0x001e:
            r1 = sViewsWithListeners;	 Catch:{ all -> 0x0062 }
            r1 = r1.size();	 Catch:{ all -> 0x0062 }
            r1 = r1 + -1;	 Catch:{ all -> 0x0062 }
        L_0x0026:
            if (r1 < 0) goto L_0x0060;	 Catch:{ all -> 0x0062 }
        L_0x0028:
            r2 = sViewsWithListeners;	 Catch:{ all -> 0x0062 }
            r2 = r2.get(r1);	 Catch:{ all -> 0x0062 }
            r2 = (java.lang.ref.WeakReference) r2;	 Catch:{ all -> 0x0062 }
            r3 = r2.get();	 Catch:{ all -> 0x0062 }
            r3 = (android.view.View) r3;	 Catch:{ all -> 0x0062 }
            if (r3 != 0) goto L_0x003e;	 Catch:{ all -> 0x0062 }
        L_0x0038:
            r4 = sViewsWithListeners;	 Catch:{ all -> 0x0062 }
            r4.remove(r1);	 Catch:{ all -> 0x0062 }
            goto L_0x005d;	 Catch:{ all -> 0x0062 }
        L_0x003e:
            r4 = r8.mViewsContainingListeners;	 Catch:{ all -> 0x0062 }
            r5 = java.lang.Boolean.TRUE;	 Catch:{ all -> 0x0062 }
            r4.put(r3, r5);	 Catch:{ all -> 0x0062 }
            r4 = r3.getParent();	 Catch:{ all -> 0x0062 }
        L_0x0049:
            r5 = r4 instanceof android.view.View;	 Catch:{ all -> 0x0062 }
            if (r5 == 0) goto L_0x005d;	 Catch:{ all -> 0x0062 }
        L_0x004d:
            r5 = r8.mViewsContainingListeners;	 Catch:{ all -> 0x0062 }
            r6 = r4;	 Catch:{ all -> 0x0062 }
            r6 = (android.view.View) r6;	 Catch:{ all -> 0x0062 }
            r7 = java.lang.Boolean.TRUE;	 Catch:{ all -> 0x0062 }
            r5.put(r6, r7);	 Catch:{ all -> 0x0062 }
            r5 = r4.getParent();	 Catch:{ all -> 0x0062 }
            r4 = r5;	 Catch:{ all -> 0x0062 }
            goto L_0x0049;	 Catch:{ all -> 0x0062 }
        L_0x005d:
            r1 = r1 + -1;	 Catch:{ all -> 0x0062 }
            goto L_0x0026;	 Catch:{ all -> 0x0062 }
        L_0x0060:
        ...
        static void registerListeningView(android.view.View r4) {
            /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:17:0x002d in {9, 10, 13, 16} preds:[]
	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.computeDominators(BlockProcessor.java:129)
	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.processBlocksTree(BlockProcessor.java:48)
	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.visit(BlockProcessor.java:38)
	at jadx.core.dex.visitors.DepthTraversal.visit(DepthTraversal.java:31)
...
*/
            ...
            r0 = sViewsWithListeners;
            monitor-enter(r0);
            r1 = sViewsWithListeners;	 Catch:{ all -> 0x002a }
            r1 = r1.iterator();	 Catch:{ all -> 0x002a }
        L_0x0009:
            r2 = r1.hasNext();	 Catch:{ all -> 0x002a }
            if (r2 == 0) goto L_0x001e;	 Catch:{ all -> 0x002a }
        L_0x000f:
            r2 = r1.next();	 Catch:{ all -> 0x002a }
            r2 = (java.lang.ref.WeakReference) r2;	 Catch:{ all -> 0x002a }
            r3 = r2.get();	 Catch:{ all -> 0x002a }
            if (r3 != r4) goto L_0x001d;	 Catch:{ all -> 0x002a }
        L_0x001b:
            monitor-exit(r0);	 Catch:{ all -> 0x002a }
            return;	 Catch:{ all -> 0x002a }
        L_0x001d:
            goto L_0x0009;	 Catch:{ all -> 0x002a }
        L_0x001e:
            r1 = sViewsWithListeners;	 Catch:{ all -> 0x002a }
            r2 = new java.lang.ref.WeakReference;	 Catch:{ all -> 0x002a }
...
*/
        ...
        static UnhandledKeyEventManager at(View root) {
            UnhandledKeyEventManager manager = (UnhandledKeyEventManager) root.getTag(C0014R.id.tag_unhandled_key_event_manager);
            if (manager != null) {
                return manager;
            }
            manager = new UnhandledKeyEventManager();
            root.setTag(C0014R.id.tag_unhandled_key_event_manager, manager);
            return manager;
        }
        ...
        private boolean onUnhandledKeyEvent(@NonNull View v, @NonNull KeyEvent event) {
            ArrayList<OnUnhandledKeyEventListenerCompat> viewListeners = (ArrayList) v.getTag(C0014R.id.tag_unhandled_key_listeners);
    ...
    public static void addOnUnhandledKeyEventListener(@NonNull View v, @NonNull OnUnhandledKeyEventListenerCompat listener) {
        if (VERSION.SDK_INT >= 28) {
            Map<OnUnhandledKeyEventListenerCompat, OnUnhandledKeyEventListener> viewListeners = (Map) v.getTag(C0014R.id.tag_unhandled_key_listeners);
            if (viewListeners == null) {
                viewListeners = new ArrayMap();
                v.setTag(C0014R.id.tag_unhandled_key_listeners, viewListeners);
            }
        ...
        ArrayList<OnUnhandledKeyEventListenerCompat> viewListeners2 = (ArrayList) v.getTag(C0014R.id.tag_unhandled_key_listeners);
        if (viewListeners2 == null) {
            viewListeners2 = new ArrayList();
            v.setTag(C0014R.id.tag_unhandled_key_listeners, viewListeners2);
        }
