...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner {
    ...
    public static class SavedState implements Parcelable {
        ...
        static class C00441 implements ClassLoaderCreator<SavedState> {
            C00441() {
            }
    ...
    class C02452 extends FragmentContainer {
        C02452() {
        }
    ...
    class C02463 implements LifecycleOwner {
        C02463() {
        }
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        boolean z = this.mState < 3 && !isVisibleToUser;
        this.mDeferStart = z;
        ...
        if (fragmentManagerImpl != null) {
            if (fragmentManagerImpl.mHost != null) {
                if (Looper.myLooper() != this.mFragmentManager.mHost.getHandler().getLooper()) {
                    this.mFragmentManager.mHost.getHandler().postAtFrontOfQueue(new C00431());
                    return;
                } else {
    ...
    void instantiateChildFragmentManager() {
        if (this.mHost != null) {
            ...
            this.mChildFragmentManager.attachController(this.mHost, new C02452(), this);
            return;
        }
    ...
    void performCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        this.mViewLifecycleOwner = new C02463();
