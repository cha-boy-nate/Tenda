...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C00672();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C00661();
    ...
    class C00672 implements OnItemClickListener {
        C00672() {
        }
