...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C02911();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C02922();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C02773();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$3 */
    class C02773 implements ViewPropertyAnimatorUpdateListener {
        C02773() {
        }
    ...
    class C02922 extends ViewPropertyAnimatorListenerAdapter {
        C02922() {
        }
...
*/
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0185R.id.decor_content_parent);
        ActionBarOverlayLayout actionBarOverlayLayout = this.mOverlayLayout;
        if (actionBarOverlayLayout != null) {
            actionBarOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0185R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0185R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0185R.id.action_bar_container);
        ...
        if (!abp.enableHomeButtonByDefault()) {
            if (!homeAsUp) {
                ...
                a = this.mContext.obtainStyledAttributes(null, C0185R.styleable.ActionBar, C0185R.attr.actionBarStyle, 0);
                if (a.getBoolean(C0185R.styleable.ActionBar_hideOnContentScroll, false)) {
                    setHideOnContentScrollEnabled(true);
                }
                elevation = a.getDimensionPixelSize(C0185R.styleable.ActionBar_elevation, 0);
                if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0185R.attr.actionBarWidgetTheme, outValue, true);
