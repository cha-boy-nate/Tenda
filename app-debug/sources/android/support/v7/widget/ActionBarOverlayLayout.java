...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    static final int[] ATTRS = new int[]{C0185R.attr.actionBarSize, 16842841};
    ...
    class C01971 extends AnimatorListenerAdapter {
        C01971() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C01971();
        this.mRemoveActionBarHideOffset = new C01982();
        this.mAddActionBarHideOffset = new C01993();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0185R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0185R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0185R.id.action_bar));
        }
    }
