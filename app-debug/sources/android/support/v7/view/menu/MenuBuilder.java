    ...
    void findItemsWithShortcutForKey(List<MenuItemImpl> items, int keyCode, KeyEvent event) {
        ...
        if (keyEvent.getKeyData(possibleChars) || i == 67) {
            ...
            for (int i2 = 0; i2 < N; i2++) {
                ...
                if (((modifierState & SupportMenu.SUPPORTED_MODIFIERS_MASK) == (SupportMenu.SUPPORTED_MODIFIERS_MASK & (qwerty ? item.getAlphabeticModifiers() : item.getNumericModifiers()))) && shortcutChar != '\u0000' && ((shortcutChar == possibleChars.meta[0] || shortcutChar == possibleChars.meta[2] || (qwerty && shortcutChar == '\b' && i == 67)) && item.isEnabled())) {
                    list.add(item);
                }
            }
        }
