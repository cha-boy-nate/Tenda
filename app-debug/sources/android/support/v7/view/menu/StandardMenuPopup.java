...
final class StandardMenuPopup extends MenuPopup implements OnDismissListener, OnItemClickListener, MenuPresenter, OnKeyListener {
    private static final int ITEM_LAYOUT = C0185R.layout.abc_popup_menu_item_layout;
    private final MenuAdapter mAdapter;
    private View mAnchorView;
    private final OnAttachStateChangeListener mAttachStateChangeListener = new C01932();
    private int mContentWidth;
    private final Context mContext;
    private int mDropDownGravity = 0;
    final OnGlobalLayoutListener mGlobalLayoutListener = new C01921();
    ...
    class C01921 implements OnGlobalLayoutListener {
        C01921() {
        }
    ...
    class C01932 implements OnAttachStateChangeListener {
        C01932() {
        }
    ...
    public StandardMenuPopup(Context context, MenuBuilder menu, View anchorView, int popupStyleAttr, int popupStyleRes, boolean overflowOnly) {
        ...
        this.mPopupMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(C0185R.dimen.abc_config_prefDialogWidth));
        ...
        if (!this.mWasDismissed) {
            ...
            if (view != null) {
                ...
                if (this.mShowTitle && this.mMenu.getHeaderTitle() != null) {
                    FrameLayout titleItemView = (FrameLayout) LayoutInflater.from(this.mContext).inflate(C0185R.layout.abc_popup_menu_header_item_layout, listView, false);
