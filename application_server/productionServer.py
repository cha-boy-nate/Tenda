...
@application.route("/user/lookup/email/<user_email>", methods=['GET'])
...
@application.route("/user/lookup/<user_id>", methods=['GET'])
def getUser(user_id):
...
@application.route("/user/event/lookup/<user_id>", methods=['GET'])
...
@application.route("/event/lookup/<event_id>", methods=['GET'])
...
#complete
@application.route("/event/attendees/<event_id>/<response>", methods=["GET"])
...
@application.route("/user/add/<string:firstName>/<string:lastName>/<string:email>/<string:password>", methods=['GET', 'POST'])
...
@application.route("/event/add/<manager_id>/<eventName>/<eventDate>/<eventTime>/<eventDuration>/<eventRadius>/<eventDescription>", methods=['GET', 'POST'])
...
@application.route("/response/add/<event_id>/<user_id>/<response>", methods=['GET', 'POST'])
...
@application.route("/manageEvent/", methods=['GET', 'POST'])
def manageEvent():
    return jsonify(result={"status": 200})
...
@application.route("/reportIssue/", methods=['GET', 'POST'])
def reportIssue():
    return jsonify(result={"status": 200})
...
@application.route("/notifyUsers/", methods=['GET', 'POST'])
def notifyUsers():
    return jsonify(result={"status": 200})
